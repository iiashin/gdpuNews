    ...
    <div id="admin">
        ...
        <div class="sideBar">
            <el-menu :default-active="activeIndex" class="el-menu-vertical-demo"
                ...
                <div class="sigh">
                    <img src="http://localhost:8976/gdpuNews/gdpu.jpg">
                </div>
                ...
                <el-submenu index="2" >
                    ...
                    <el-menu-item-group>
                        <el-menu-item index="2-1">已发布</el-menu-item>
                ...
                <el-submenu index="3">
                    ...
                    <el-menu-item-group>
                        <el-menu-item index="3-1">新闻输入员</el-menu-item>
                    </el-menu-item-group>
                </el-submenu>
            </el-menu>
        </div>
...
<script>
    ...
    import AdminAddNews from '../components/AdminAddNews.vue'
    import AdminCheck from '../components/AdminCheck.vue'
    import AdminPublished from '../components/AdminPublished.vue'
    import AdminWriter from '../components/AdminWriter.vue'
    export default {
        components:{AdminHome,AdminAddNews,AdminCheck,AdminPublished,AdminWriter},
        data() {
            return {
                isCollapse: false,
                componentId:'AdminHome',
